...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('getEAP_TLS', '0014_mycustomca_alter_wifinetworklocation_certificates_ca'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='getEAP_TLS.mycustomcert'),
        ),
        migrations.AlterField(
            model_name='wifiuser',
            name='certificate',
