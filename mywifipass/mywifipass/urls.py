...
from fido2_poc.views import assetlinks_json
...
urlpatterns = [
    ...
    # Digital Asset Links for Android app verification (NO REDIRECT - direct serve required by Android)
    re_path(r'^\.well-known/assetlinks\.json$', assetlinks_json, name='assetlinks_root'),
